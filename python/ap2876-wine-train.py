...
#Loading the dataset
df = spark.read.format("csv").load("s3://sj764-wine-prediction/TrainingDataset.csv" , header = True ,sep =";")
df.printSchema()
df.show()
...
#save training model
RFmodel.save(sc, 's3://sj764-wine-prediction/trainingmodel.model')